    ...
    <body >
        ...
        <tr>
            ...
            <%
                ...
                fields = shr.getSharingFields();
                fi = fields.listIterator();

                rows = shr.getSharingsClientwise(uid);
                ...
                if(rows.size() >0)
                {
                    ...
                    out.println("<form name= f method= \"post\" action= \"manageSharings.jsp\" onsubmit= \"return chk()\" >");
                ...
                {
                    out.println("<h2>No Sharings Done</h2>");
                }
                %>
            </table>
