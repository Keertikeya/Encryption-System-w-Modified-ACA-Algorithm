...
<jsp:useBean id="clnts"  class= "datasentinel.Client" scope="page" />
    ...
    <body >
        ...
        <tr>
            ...
            <%
                ...
                fields = clnts.getClientFields();
                fi = fields.listIterator();

                rows = clnts.getAllClientsInfo();
                ...
                if(rows.size() >0)
                {
                    ...
                    out.println("<form name= f method= \"post\" action= \"manageClients.jsp\" onsubmit= \"return chk()\" >");
                ...
                {
                    out.println("<h2>No Clients Registered</h2>");
                }
                %>
            </table>
            </td>
