...
<jsp:useBean id="shld"  class= "datasentinel.Shieldings" scope="page" />
    ...
    <head>
        ...
        <script type="text/javascript" language="javascript">
            ...
            function chk()
            {
                ...
                alert("Select Shielding To UnSHield");
                return false;
            }
        </script>
    </head>
        ...
        <tr>
            ...
            <%
                ...
                if(rows.size() >0)
                {
                    ...
                    out.println("<tr>");
                    out.println("<td >");
                    out.println("<input type = \"submit\" name = \"bttnUnShield\" value = \"Unshield\">");
                    out.println("</td>");
                    out.println("</tr>");
                    out.println("</form>");
